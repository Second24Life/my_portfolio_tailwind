        ...
        return (
          <SwiperSlide key={index}>
            <div className="flex flex-col items-center h-full px-16 md:flex-row gap-x-8">
              ...
              {/* Quote */}
              <div className=" flex-1 flex-col flex justify-center before:w-[1px] xl:before:bg-white/20 xl:before:absolute xl:before:left-0 xl:before:h-[200px] relative xl:pl-20">
                <div className="mb-4">
